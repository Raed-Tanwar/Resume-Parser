...
class Experience(BaseModel):
    company: str | None = None  # optional details (preference given)
    role: str | None = None
...
# resume is taken and pdf and word format. using pythonn function to read through it
...
# comparing the standard schema with the resume which are made into our schema
